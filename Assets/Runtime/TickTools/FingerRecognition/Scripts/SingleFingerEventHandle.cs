...
namespace Tick
{
    public class SingleFingerEventHandle : SingleMonoBehaviour<SingleFingerEventHandle>, IFingerOperationHandle
    {
        ...
        public GameObject CheckCurrentDown { get => m_checkCurrentDown; set => m_checkCurrentDown = value; }//按下的时候检测到的对象
        public GameObject CheckCurrentHold { get => m_checkCurrentHold; set => m_checkCurrentHold = value; }//当前手指检测到的对象
